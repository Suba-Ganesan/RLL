...
export class AdminDashboardComponent implements OnInit {
  ...
  sortData(sort:Sort){
    ...
    this.sortedProd=data.sort((a,b)=>{
      ...
      switch(sort.active){
        ...
        case 'desc':return this.compare(a.name,b.name,isAsc);
        case 'duration':return this.compare(a.category,b.category,isAsc);
  ...
  addProduct(){
    ...
    this.productModelObj.duration=this.formValue.value.duration;
  ...
  onEdit(prod:any){
    ...
    this.formValue.controls['duration'].setValue(prod.duration);
