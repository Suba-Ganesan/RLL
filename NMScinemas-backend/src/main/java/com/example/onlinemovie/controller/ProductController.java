...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(1,"Fantstic mr.fox","George clooney,meryl streep as felicity","2hr:30min",1234567,"Comedy", 350,0,0,"yes","./assets/images/fantastic.jpeg"));
			addProdIfEmpty(new Product(1,"Jungle Cruise","Dwanye  Johnson, Emily Blunt, Edger Ramirez","2hr:45min",1234567,"Comedy", 350,0,0,"yes","./assets/images/jungle.jpeg"));
			addProdIfEmpty(new Product(2,"RRR","N.T.Ramarao as komaram bheem, ram charan as alluri sitaramaraju","3hr:15min",1234567,"Historical", 350,0,0,"yes","./assets/images/rrr.jpeg"));
			addProdIfEmpty(new Product(1,"Samrat Prithviraj","Akshay kuar, manushi chhillar, manav vij,sonu sood","2hr:45min",1234567,"Historical", 350,0,0,"yes","./assets/images/samrat.jpeg"));
			addProdIfEmpty(new Product(1,"Runway 34","Ajay Devgn,Amitabh bachchan, Rakul preet","2hr:35min",1234567,"Thriller", 350,0,0,"yes","./assets/images/thriller.jpeg"));
			addProdIfEmpty(new Product(1,"MARAKKAR","Mohanlal as mammali, Arjun sarja","2hr:45min",1234567,"Drama", 350,0,0,"yes","./assets/images/marakkar.jpeg"));
